...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Flame-Shanto                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : A Email Toolkit               \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/Shanto75o\033[94m│".center(columns+9))
...
def contact():
    ...
    psb("\n\033[92m    [\033[37m★\033[92m] Contact with Flame-Shanto Via Email:\n")
    print("\033[37m[\033[94m 01777433876 \033[37m]".center(columns+13))
    time.sleep(0.6)
    psb("\n\033[92m    [\033[37m★\033[92m] You Can Also Contact Via Facebook Page!")
    l = input("\n\033[92m    [\033[37m★\033[92m] Press Enter To Visit Flame-Shanto Facebook Page....")
    os.system("xdg-open https://www.facebook.com/profile.php?id=100086242797107")
...
def logout():
    ...
    print("\033[94m[\033[37m https://github.com/Flame-Shanto/ \033[94m]".center(columns+13))
    sys.exit("\033[37m")
